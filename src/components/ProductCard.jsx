...
function StarRating({ rating = 0, count = 0, maxStars = 5 }) {
...
export default function ProductCard({ product, onAdd = () => {} }) {
  ...
  const productImage1 = images[0] || "/placeholder.png";
  const productImage2 = images[1] || productImage1;
  ...
  return (
    ...
    >
      <Link to={`/product/${product?.id}`} className="block h-full">
        {/* DISCOUNT TAG */}
        {hasDiscount && (
          <div className="text-sm text-white bg-primary font-medium absolute right-3 top-3 z-30 px-2 rounded-md">
            ...
            <motion.button
              ...
              onClick={(e) => {
                ...
                onAdd({
                  ...
                  qty: 1,
                  selectedOptions:
                    variants[0] || { color: "Default", size: "M" },
                });
              }}
