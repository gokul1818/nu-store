export default function RefundPolicy() {
    return (
        <div className="container mx-auto px-4 py-10">
            ...
            <p className="text-gray-700 mb-4">
                You have <strong>3 days</strong> from the date of delivery to request a return or exchange.
            </p>
            ...
            <ul className="list-disc pl-6 text-gray-700 mb-4 space-y-1">
                ...
                <li>
                    A <strong>mandatory unboxing video</strong> is required (from opening the parcel to showing the product fully).
                </li>
            </ul>
            ...
            <p className="text-gray-700 mb-4">
                ...
                To cancel, contact us via email or WhatsApp (details below).
            </p>

            {/* Request Return / Exchange */}
            <h3 className="font-semibold mt-6 mb-2">📩 How to Request a Return or Exchange</h3>
            <ul className="list-disc pl-6 text-gray-700 mb-4 space-y-1">
            ...
            <ul className="list-disc pl-6 text-gray-700 mb-4 space-y-1">
                <li>Refunds are processed within <strong>3–5 working days</strong> after we receive the returned product.</li>
                <li>Prepaid orders: refunded to the original payment method.</li>
                <li>COD orders: refunded to your bank account (we’ll collect details during the process).</li>
            </ul>
            ...
            <p className="text-gray-700 mb-4">
                ...
                <strong>#12-15, Sri Sai Upadhyaya Nagar, J K Nagar Extension, Pichatoor road, Srikalahasthi- 517644</strong>.
            </p>
            ...
            <p className="text-gray-700">
                ...
                <br />
                WhatsApp:{" "}
                <a href="https://wa.me/919100015419" className="text-blue-600 underline">
                    +91-9100015419
                </a>
            </p>
        </div>
